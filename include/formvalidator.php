...
define("E_VAL_REQUIRED_VALUE","Внесете вредност за %s");
define("E_VAL_MAXLEN_EXCEEDED","Надмината е максималната должина за %s.");
define("E_VAL_MINLEN_CHECK_FAILED","Внесете запис со должина поголема од %d за %s");
define("E_VAL_ALNUM_CHECK_FAILED","Внесете алфанумерички запис за %s");
define("E_VAL_ALNUM_S_CHECK_FAILED","Внесете алфанумерички запис за %s");
define("E_VAL_NUM_CHECK_FAILED","Внесете нумерички запис за %s");
define("E_VAL_ALPHA_CHECK_FAILED","Внесете алфабетски запис за %s");
define("E_VAL_ALPHA_S_CHECK_FAILED","Внесете алфабетски запис за %s");
define("E_VAL_EMAIL_CHECK_FAILED","Внесете email адреса");
define("E_VAL_LESSTHAN_CHECK_FAILED","Внесете запис помал од %f за %s");
define("E_VAL_GREATERTHAN_CHECK_FAILED","Внесете запис поголем од %f за %s");
define("E_VAL_REGEXP_CHECK_FAILED","Внесете валиден запис за %s");
define("E_VAL_DONTSEL_CHECK_FAILED","Изберена е погрешна опција за %s");
define("E_VAL_SELMIN_CHECK_FAILED","Изберете минимум %d опции за %s");
define("E_VAL_SELONE_CHECK_FAILED","Изберете опција за %s");
define("E_VAL_EQELMNT_CHECK_FAILED","Вредноста на %s треба да е иста како таа на %s");
define("E_VAL_NEELMNT_CHECK_FAILED","Вредноста на %s не треба да е иста како таа на %s");
